    ...
    <main className="py-16  px-4 sm:px-6">
      <div className="max-w-5xl mx-auto text-center">
        <h1 className=" text-3x1 sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight">
          Conheça o <span className="text-people-color-neon">Nosso Time</span>
        </h1>
        <p className="mt-6 text-base sm:text-lg text-white max-w-2xl  tracking-wide    font-light  w-4/5 mx-auto">
          Nós da <span className="font-bold text-people-color-neon ">Unmted</span> somos um
          grupo apaixonado por tecnologia, design e inovação. Cada membro traz
          uma expertise única para construir experiências incríveis.
        </p>
      </div>
